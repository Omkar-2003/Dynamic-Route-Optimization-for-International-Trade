...
var SDK = /** @class */ (function () {
    function SDK() {
        ...
        this.core = new core_1.default(this.spec, 'searoutes-docs/2.10.0 (api/6.1.1)');
    }
    /**
     ...
     */
    SDK.prototype.getCO2Tender = function (metadata) {
        return this.core.fetch('/co2/v2/plan', 'get', metadata);
    };
    /**
    ...
    SDK.prototype.getItineraryByHash = function (metadata) {
        return this.core.fetch('/itinerary/v2/hash/{hash}', 'get', metadata);
    };
    /**
    ...
    SDK.prototype.getSeaRoute = function (metadata) {
        return this.core.fetch('/route/v2/sea/{coordinates}', 'get', metadata);
    };
    /**
     * This endpoints returns the route between a source location and a target location on sea,
    ...
    SDK.prototype.getPlanSeaRoute = function (metadata) {
        return this.core.fetch('/route/v2/sea/{coordinates}/plan', 'get', metadata);
    };
    /**
     ...
     */
    SDK.prototype.getVesselEta = function (metadata) {
        return this.core.fetch('/vessel/v2/{imo}/eta', 'get', metadata);
    };
    /**
     ...
     */
    SDK.prototype.getWeatherForecast = function (metadata) {
        return this.core.fetch('/weather/v2/forecast', 'get', metadata);
    };
    /**
     ...
     */
    SDK.prototype.postWeather = function (body) {
        return this.core.fetch('/weather/v2/track', 'post', body);
    };
    return SDK;
}());
